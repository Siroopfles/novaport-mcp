...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_context_links_relationship_type"),
        "context_links",
        ["relationship_type"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_custom_data_category"), "custom_data", ["category"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_custom_data_timestamp"), "custom_data", ["timestamp"], unique=False
    )
    op.create_table(
        "decisions",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_decisions_summary"), "decisions", ["summary"], unique=False
    )
    op.create_index(
        op.f("ix_decisions_timestamp"), "decisions", ["timestamp"], unique=False
    )
    op.create_table(
        "product_context",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_progress_entries_status"), "progress_entries", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_progress_entries_timestamp"),
        "progress_entries",
        ["timestamp"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_system_patterns_id"), "system_patterns", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_system_patterns_name"), "system_patterns", ["name"], unique=True
    )
    op.create_index(
        op.f("ix_system_patterns_timestamp"),
        "system_patterns",
        ["timestamp"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_context_links_relationship_type"), table_name="context_links"
    )
